...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".sprintf(__('%s - Help', 'post-grid'),post_grid_plugin_name)."</h2>";?>
    ...
    <div class="para-settings post-grid-settings">
        ...
        <ul class="tab-nav"> 
            ...
            <li nav="1" class="nav1 active"><?php _e('Help & support','post-grid' ); ?></li>       
		...
		<ul class="box">
            ...
            <li style="display: block;" class="box2 tab-box active">
				<div class="option-box">
                    <p class="option-title"><?php _e('Need Help ?','post-grid' ); ?></p>
                    <p class="option-info"><?php _e('Feel free to contact with any issue for this plugin, Ask any question via forum','post-grid' ); ?> <a href="<?php echo post_grid_qa_url; ?>"><?php echo post_grid_qa_url; ?></a><br />
				...
				<div class="option-box">
                    <p class="option-title"><?php _e('Video Tutorial','post-grid' ); ?></p>
                    <p class="option-info"><?php _e('Please watch video tutorial, some features may not available in Free version.','post-grid' ); ?></p>
                    
                    <div class="tutorials expandable">
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('How to install activate & license','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('How to create Post Grid','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('Post Grid - Query Post','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('Post Grid - Grid Layout','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('Post Grid - Navigations','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('Post Grid - Layout Editor','post-grid' ); ?></div>
                            <div class="options">
                    	...
                    	<div class="items">
                        	<div class="header "><i class="fa fa-play"></i>  <?php _e('Post Grid - Settings','post-grid' ); ?></div>
                            <div class="options">
				...
				<div class="option-box">
                    <p class="option-title"><?php _e('Submit Reviews.','post-grid' ); ?></p>
                    <p class="option-info"><?php _e('We are working hard to build some awesome plugins for you and spend thousand hour for plugins. we wish your three(3) minute by submitting five star reviews at wordpress.org. if you have any issue please submit at forum.','post-grid' ); ?></p>
